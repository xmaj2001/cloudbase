...
import { XDefaultScopes, XScalarAuthUrl, XScalarCredentialsLocation, XScalarSecurityBody, XScalarSecurityQuery, XScalarTokenUrl, XTokenName, XusePkce, } from '../../extensions/security/index.js';
...
export const securityScheme = union([apiKeySecurityScheme, httpSecurityScheme, oauth2SecurityScheme, openIdConnectSecurityScheme], { typeName: 'SecuritySchemeObject' });

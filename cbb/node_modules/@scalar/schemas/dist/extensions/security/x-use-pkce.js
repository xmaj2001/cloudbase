...
export const XusePkce = object({
    ...
    typeName: 'XusePkce',
    typeComment: typeCommentWithExample('Enables Proof Key for Code Exchange (PKCE) for the OAuth2 authorization code flow.', { language: 'yaml', body: 'x-usePkce: SHA-256' }),
});

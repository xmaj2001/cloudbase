...
export const XDisabled = object({
    ...
    typeName: 'XDisabled',
    typeComment: typeCommentWithExample(`Whether a parameter example is disabled in the API client (${typeCommentInlineCode('true')} = not sent).`, { language: 'yaml', body: 'x-disabled: true' }),
});

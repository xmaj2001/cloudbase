...
import { typeCommentExample, typeCommentSections } from '../type-comment.js';
/**
...
export const XScalarDisableParameters = object({
    ...
    typeComment: typeCommentSections('Tracks which parameters are disabled across examples in the API client.', 'Structure: category (global-cookies, global-headers, default-headers) → example key → parameter name → true if disabled.', typeCommentExample('json', `{
  "x-scalar-disable-parameters": {
    "default-headers": {

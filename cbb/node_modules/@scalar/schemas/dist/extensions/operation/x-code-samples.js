...
import { typeCommentInlineCode, typeCommentWithExample } from '../type-comment.js';
...
export const XCodeSamples = object({
    ...
    'x-stainless-snippets': optional(record(string(), string(), { typeComment: 'Stainless snippets, source code keyed by language' })),
    'x-stainless-examples': optional(XLanguageExamples),
    'x-scalar-examples': optional(array(XCodeSample, { typeComment: 'Scalar code samples (same shape as x-codeSamples)' })),
}, {
